...
int	main(int argc, char **argv)
{
    ...
    // huffman("MANY OF YOU ARE GONNA DIE BUT THATS A SACRIFICE IM WILLING TO MAKE");
	huffman("hola que tal estas?");
	// huffman("Never gonna give you up, never gonna let you down Never gonna run around and desert you Never gonna make you cry, never gonna say goodbye Never gonna tell a lie and hurt you");
	return 0 ;
}